...
export const GUIDED_SETUP_CONTENT: Record<string, SetupGuide> = {
  instagram_facebook: {
    ...
    steps: [
      ...
      },
      {
        ...
        description: 'In Instagram Basic Display settings, paste the return address below into "Valid Redirect Addresses".',
        inputField: {
          key: 'redirectUri',
  ...
  linkedin: {
    ...
    steps: [
      ...
      {
        stepNumber: 4,
        title: 'Copy Application ID and Security Password',
  ...
  google: {
    ...
    steps: [
      ...
      {
        stepNumber: 3,
        title: 'Create connection credentials',
        description: 'Go to Credentials, click "Create Credentials", select "OAuth client ID", and choose "Web Application".',
      },
      {
        stepNumber: 4,
        title: 'Add return address',
        description: 'Add the return address below to the Authorized Redirect Addresses.',
        inputField: {
          key: 'redirectUri',
          label: 'Copy this return address',
  ...
  canva: {
    ...
    steps: [
      ...
      },
      {
        ...
        description: 'Enter your app name (e.g., "VIMO"), add a description, and set the return URL below.',
      },
      {
        stepNumber: 3,
        title: 'Add return address',
        description: 'In your app settings, add the return address below to the "Allowed Redirect URLs" field.',
        inputField: {
          key: 'redirectUri',
          label: 'Copy this return address',
      ...
      },
      {
        stepNumber: 4,
        title: 'Copy your Application ID',
        description: 'From the app dashboard, copy the Application ID.',
        inputField: { key: 'clientId', label: 'Application ID', placeholder: 'Your Canva Application ID', isSecret: false },
      },
      {
        stepNumber: 5,
        title: 'Copy your Security Password',
  ...
  facebook: {
    ...
    steps: [
      ...
      },
      {
        stepNumber: 3,
        title: 'Add return address',
        description: 'In Facebook Login > Settings, add the return address below to "Valid Redirect Addresses".',
        inputField: {
          key: 'redirectUri',
          label: 'Copy this return address',
          placeholder: `http://localhost:${process.env.PORT || 3000}/api/auth/oauth/callback`,
  ...
  x: {
    ...
    steps: [
      ...
      },
      {
        ...
        description: 'In "User authentication settings", set App permissions to "Read and write", type to "Web App", and enable Secure Login.',
      },
      {
        stepNumber: 3,
        title: 'Add return address',
        description: 'Add the return address below to "Callback URI / Redirect URL".',
        inputField: {
          key: 'redirectUri',
          label: 'Copy this return address',
          placeholder: `http://localhost:${process.env.PORT || 3000}/api/auth/oauth/callback`,
      ...
      },
      {
        stepNumber: 4,
        title: 'Copy your Application ID',
        description: 'From the "Keys and tokens" page, copy the Application ID.',
  ...
  tiktok: {
    ...
    steps: [
      ...
      {
        stepNumber: 2,
        title: 'Configure Secure Login',
        description: 'Set the app type to "Web App", add the return URL below, and request the "Display Basic Videos" and "Upload Videos" scopes.',
      },
      {
        stepNumber: 3,
        title: 'Add return address',
      ...
      },
      {
        stepNumber: 4,
        title: 'Copy your Application ID',
        description: 'From the app credentials page, copy the Application ID.',
        inputField: { key: 'clientId', label: 'Application ID', placeholder: 'Your TikTok Application ID', isSecret: false },
      },
      {
        stepNumber: 5,
        title: 'Copy your Security Password',
  ...
  youtube: {
    ...
    steps: [
      ...
      },
      {
        stepNumber: 3,
        title: 'Add return address',
        description: 'Add the return address below to the client\'s "Authorized redirect URIs".',
        inputField: {
          key: 'redirectUri',
          label: 'Copy this return address',
          placeholder: `http://localhost:${process.env.PORT || 3000}/api/auth/oauth/callback`,
      ...
      },
      {
        stepNumber: 4,
        title: 'Copy your Application ID',
        description: 'Copy the Application ID from the connection credentials.',
        inputField: { key: 'clientId', label: 'Application ID', placeholder: 'Your Google Application ID', isSecret: false },
      },
      {
        stepNumber: 5,
  ...
  pinterest: {
    ...
    steps: [
      ...
      },
      {
        stepNumber: 2,
        title: 'Configure app',
        description: 'Set the app to "Web app", add the return URL below, and request the boards, pins, and user account scopes.',
      },
      {
        stepNumber: 3,
        title: 'Add return address',
        description: 'Add the return address below to "Redirect URIs".',
        inputField: {
          key: 'redirectUri',
          label: 'Copy this return address',
          placeholder: `http://localhost:${process.env.PORT || 3000}/api/auth/oauth/callback`,
  ...
  threads: {
    ...
    steps: [
      ...
      },
      {
        ...
        description: 'Add the return URL below and request the threads_basic, threads_content_publish, and threads_manage_replies scopes.',
      },
      {
        stepNumber: 3,
        title: 'Add return address',
        description: 'Add the return address below to "Valid Redirect Addresses".',
        inputField: {
          key: 'redirectUri',
          label: 'Copy this return address',
          placeholder: `http://localhost:${process.env.PORT || 3000}/api/auth/oauth/callback`,
  ...
  reddit: {
    ...
    steps: [
      ...
      },
      {
        stepNumber: 2,
        title: 'Configure app',
        description: 'Choose "web app", set the return URL below, and note your Application ID (under the app name) and Security Password.',
      },
      {
        stepNumber: 3,
        title: 'Add return address',
        description: 'Set the return address below as the app\'s return address.',
        inputField: {
          key: 'redirectUri',
          label: 'Copy this return address',
          placeholder: `http://localhost:${process.env.PORT || 3000}/api/auth/oauth/callback`,
      ...
      },
      {
        stepNumber: 5,
        title: 'Copy your Security Password',
        description: 'Copy the password shown next to "secret".',
  ...
  medium: {
    ...
    steps: [
      ...
      },
      {
        ...
        description: 'Create an app at medium.com/me/applications with the return URL below.',
        inputField: {
          key: 'redirectUri',
          label: 'Copy this return address',
          placeholder: `http://localhost:${process.env.PORT || 3000}/api/auth/oauth/callback`,
  ...
  github: {
    ...
    steps: [
      ...
      },
      {
        ...
        description: 'Enter "VIMO" as the Application Name, your homepage URL, and the return URL below.',
      },
      {
        stepNumber: 3,
        title: 'Add return address',
        description: 'Set the Authorization return address to the address below.',
        inputField: {
          key: 'redirectUri',
          label: 'Copy this return address',
          placeholder: `http://localhost:${process.env.PORT || 3000}/api/auth/oauth/callback`,
